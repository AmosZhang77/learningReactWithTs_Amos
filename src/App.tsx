...
// npm script(在package.json的script命令中)能做到的原理时。他会启动一个shell来运行命令，运行之前将需要的js，node_modules/.bin目录加入运行的path，所以就有了。

// 用npx就可以不全局安装 mocha，而 npx mocha -version // 可以直接命令了
